 ...
 * {@link RequestTagging#get()}. With the received {@link #STATUS} you can add
 * request meta data e.g. a the name of the resource which has been called with
 * the current request.
 *
...
public class RequestTagging {
    ...
    public interface Status {
        ...
        /**
         * Report the status of this request. If the request has been ignored
         * before by invoking {@link #ignore()} this will be reverted and
        ...
        /**
         * Add an explicit resource name to the given request status for better
         * separation.
         * 
         * @param name The resource which has been invoked by the current
         *            request.
         * @return This instance for further updates.
         */
        ...
        /**
         * Add an optional key - value meta data pair for better separation.
         * E.g. client information could be added here or further resource
         * information.
         * 
         ...
         * @return This instance for further updates.
         */
        Status startTimer(String id);
        
        /**
         * Stop a timer with the given id for measuring durations.
         * 
         * @param id The id of the timer.
         * @return This instance for further updates.
         */
        Status stopTimer(String id);

        /**
         * Allow another runnable to report the status of this request. This is
         * useful when you have asynchronous request processing inside your
         * application. The runnable will receive its own copy of the current
         * status so you can decide what should happen with the current status.
         * 
         * @param runnable The runnable which should be able to report a request
         *            status.
         * @return A runnable which wraps the given runnable and enables request
         *         tagging.
         */
    ...
    /**
     * Initialize request tagging with the given status. The caller of this
     * method is responsible for removing request tagging status when request
     * processing is done with {@link #remove()} <br>
     * <br>
     * <b>This method is intended for request tagging providers. Users of
     * request tagging should only call {@link #get()} or {@link #getOptional()}
     * </b>
     * 
    ...
    /**
     * @return The status for the given request if request tagging is enabled
     *         for it. Otherwise {@link Optional#empty()}
     */
    ...
    /**
     * Remove the current request tagging status. <br>
     * <br>
     * <b>This method is intended for request tagging providers. Users of
     * request tagging should only call {@link #get()} or {@link #getOptional()}
     * </b>
    ...
    /**
     * A default status implementation which is used when request tagging is
     * disabled.
     */
